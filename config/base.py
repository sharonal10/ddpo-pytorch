...
def get_config():
    ...
    train.batch_size = 1 # unsure if setting both batch sizes like this without changing anything else is fine, check again when adjusting hyperparams
    ...
    config.prompt_fn_kwargs = {'item': 'plane', 'perspectives': ('top', 'side', 'slanted')} # change

    ###### Reward Function ######
    # reward function to use. see `rewards.py` for available reward functions.
    # config.reward_fn = "jpeg_compressibility"
    config.reward_fn = "fm_similarity"
